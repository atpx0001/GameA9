...
public abstract class AbstractGoTween
{
	...
	public Action<AbstractGoTween> _onUpdate; // execute whenever a tween updates.
	protected Action<AbstractGoTween> _onIterationEnd; // executes whenever a tween ends an iteration.
	public Action<AbstractGoTween> _onComplete; // exectures whenever a tween completes
