...
public class ColorTweenProperty: AbstractMaterialColorTweenProperty, IGenericProperty {
    ...
    public ColorTweenProperty(Func<Color> getter, Action<Color> setter, Color endValue, bool isRelative = false)
        : base(endValue, isRelative) {
        this._setter = setter;
        this._getter = getter;
    }
    ...
    public override void prepareForUse() {
        // retrieve the getter
        var getter = _getter != null ? _getter : GoTweenUtils.getterForProperty<Func<Color>>(_ownerTween.target, propertyName);
